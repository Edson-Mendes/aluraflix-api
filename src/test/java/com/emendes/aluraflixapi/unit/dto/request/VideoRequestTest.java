...
class VideoRequestTest {
  ...
  private final Integer VALID_CATEGORY_ID = 1000;
  ...
  class TitleValidation {
    ...
    void validateTitle_MustNotReturnViolations_WhenTitleIsValid(String title) {
      VideoRequest videoRequest = new VideoRequest(title, VALID_DESCRIPTION, VALID_URL, VALID_CATEGORY_ID);

      Set<ConstraintViolation<VideoRequest>> actualViolations = validator.validateProperty(
          videoRequest, "title", CreateInfo.class);
    ...
    void validateTitle_MustReturnViolations_WhenTitleIsNull() {
      VideoRequest videoRequest = new VideoRequest(null, VALID_DESCRIPTION, VALID_URL, VALID_CATEGORY_ID);
    ...
    void validateTitle_MustReturnViolations_WhenTitleIsEmpty() {
      VideoRequest videoRequest = new VideoRequest("", VALID_DESCRIPTION, VALID_URL, VALID_CATEGORY_ID);
    ...
    void validateTitle_MustReturnViolations_WhenTitleSizeIsBiggerThan100Characters() {
      ...
      VideoRequest videoRequest = new VideoRequest(titleWith101Characters, VALID_DESCRIPTION, VALID_URL, VALID_CATEGORY_ID);
  ...
  class DescriptionValidation {
    ...
    void validateDescription_MustNotReturnViolations_WhenDescriptionIsValid(String description) {
      VideoRequest videoRequest = new VideoRequest(VALID_TITLE, description, VALID_URL, VALID_CATEGORY_ID);

      Set<ConstraintViolation<VideoRequest>> actualViolations = validator.validateProperty(
          videoRequest, "description", CreateInfo.class);
    ...
    void validateDescription_MustReturnViolations_WhenDescriptionIsNull() {
      VideoRequest videoRequest = new VideoRequest(VALID_TITLE, null, VALID_URL, VALID_CATEGORY_ID);
    ...
    void validateDescription_MustReturnViolations_WhenDescriptionIsEmpty() {
      VideoRequest videoRequest = new VideoRequest(VALID_TITLE, "", VALID_URL, VALID_CATEGORY_ID);
    ...
    void validateDescription_MustReturnViolations_WhenDescriptionSizeIsBiggerThan100Characters() {
      String descriptionWith256Characters = "description xptodescription xptodescription xptodescription xpto" +
          ...
          "description xptodescription xptodescription xptodescription xpto" +
          "description xptodescription xptodescription xptodescription xpto";
      VideoRequest videoRequest = new VideoRequest(VALID_TITLE, descriptionWith256Characters, VALID_URL, VALID_CATEGORY_ID);
  ...
  class UrlValidation {
    ...
    void validateUrl_MustNotReturnViolations_WhenUrlIsValid() {
      VideoRequest videoRequest = new VideoRequest(VALID_TITLE, VALID_DESCRIPTION, "http://www.xptovideos.com", VALID_CATEGORY_ID);

      Set<ConstraintViolation<VideoRequest>> actualViolations = validator.validateProperty(
          videoRequest, "url", CreateInfo.class);
    ...
    void validateUrl_MustReturnViolations_WhenUrlIsNull() {
      VideoRequest videoRequest = new VideoRequest(VALID_TITLE, VALID_DESCRIPTION, null, VALID_CATEGORY_ID);
    ...
    void validateUrl_MustReturnViolations_WhenUrlIsEmpty() {
      VideoRequest videoRequest = new VideoRequest(VALID_TITLE, VALID_DESCRIPTION, "", VALID_CATEGORY_ID);
    ...
    void validateUrl_MustReturnViolations_WhenUrlSizeIsBiggerThan100Characters() {
      String urlWith256Characters = "http://www.xptovideos.com/loremlorem" +
          ...
          "loremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremlorem";
      VideoRequest videoRequest = new VideoRequest(VALID_TITLE, VALID_DESCRIPTION, urlWith256Characters, VALID_CATEGORY_ID);
    ...
    void validateUrl_MustReturnViolations_WhenUrlIsntAWellFormedUrl(String invalidUrl) {
      VideoRequest videoRequest = new VideoRequest(VALID_TITLE, VALID_DESCRIPTION, invalidUrl, VALID_CATEGORY_ID);
  ...
  @Nested
  @DisplayName("Tests for categoryId validation")
  class CategoryIdValidation {

    @Test
    @DisplayName("Validate categoryId must not return violations when categoryId is valid")
    void validateCategoryId_MustNotReturnViolations_WhenCategoryIdIsValid() {
      VideoRequest videoRequest = new VideoRequest(VALID_TITLE, VALID_DESCRIPTION, VALID_URL, 1000);

      Set<ConstraintViolation<VideoRequest>> actualViolations = validator.validateProperty(
          videoRequest, "categoryId", UpdateInfo.class);

      Assertions.assertThat(actualViolations).isEmpty();
    }

    @Test
    @DisplayName("Validate categoryId must return violations when categoryId is null")
    void validateCategoryId_MustReturnViolations_WhenCategoryIdIsNull() {
      VideoRequest videoRequest = new VideoRequest(VALID_TITLE, VALID_DESCRIPTION, VALID_URL, null);
    ...
    @Test
    @DisplayName("Validate categoryId must not return violations when categoryId is valid")
    void validateCategoryId_MustNotReturnViolations_WhenGroupIsCreateInfo() {
      VideoRequest videoRequest = new VideoRequest(VALID_TITLE, VALID_DESCRIPTION, VALID_URL, null);

      Set<ConstraintViolation<VideoRequest>> actualViolations = validator.validateProperty(
          videoRequest, "categoryId", CreateInfo.class);
